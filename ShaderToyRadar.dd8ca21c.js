import{d as p,u as d,o as m,c as f,m as _,_ as u}from"./index.78dd451b.js";const g={class:"mm-container"},e=window.Cesium,v=p({__name:"ShaderToyRadar",setup(h,{expose:c}){d();const t=window.viewer,o=()=>{!t||t.scene.primitives.removeAll()};return(()=>{if(!t)return;o(),_.info("\u6570\u636E\u52A0\u8F7D\u4E2D!");var s=new e.CircleGeometry({vertexFormat:e.VertexFormat.POSITION_NORMAL_AND_ST,center:e.Cartesian3.fromDegrees(110,40),radius:1e5,height:3e3}),a=e.CircleGeometry.createGeometry(s);let l=new e.GeometryInstance({geometry:a}),r=new e.MaterialAppearance({material:new e.Material({fabric:{uniforms:{iTime:0},source:`
